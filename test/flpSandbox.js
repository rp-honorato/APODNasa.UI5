			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apodui5-display": {
								"semanticObject": "apodui5",
								"action": "display",
								"description": "Astronomic pic of day!",
								"title": "APOD with UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apodui5",
									"url": sap.ui.require.toUrl("apodui5")
								}
							}
						}
					}
